...
DART: TOWER = TOWER(x = 617, y = 402, name = 'Dart Monkey', currMonkey = True, key = 'q', path = [{1: 3, 2: 2}], currUpgrades = [0, 0, 0])
SUPER: TOWER = TOWER(x = 641, y = 514, name = 'Super Monkey', currMonkey = False, key = 's', path = [{2: 2, 0: 2}, {2: 2}], currUpgrades = [0, 0, 0])
TACK: TOWER = TOWER(x = 496, y = 495, name = 'Tack Shooter', currMonkey = False, key = 'r', path = [{0: 2, 2: 5}], currUpgrades = [0, 0, 0])
VILLAGE: TOWER = TOWER(x = 431, y = 552, name = 'Monkey Village', currMonkey = False, key = 'k', path = [{0: 3, 1: 2}], currUpgrades = [0, 0, 0])
ALCHEMIST: TOWER = TOWER(x = 422, y = 400, name = 'Alchemist', currMonkey = False, key = 'f', path = [{0: 4, 2: 2}, {0: 1}], currUpgrades = [0, 0, 0])
