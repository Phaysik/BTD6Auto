...
# CONSTS
ADORA: TOWER = TOWER(x = 474, y = 406, name = 'Adora', currMonkey = False, key = 'u')
DART: TOWER = TOWER(x = 591, y = 403, name = 'Dart Monkey', currMonkey = True, key = 'q', path = [{1: 3, 2: 2}], currUpgrades = [0, 0, 0])
SUPER: TOWER = TOWER(x = 616, y = 513, name = 'Super Monkey', currMonkey = False, key = 's', path = [{2: 2, 0: 2}, {2: 2}], currUpgrades = [0, 0, 0])
TACK: TOWER = TOWER(x = 476, y = 495, name = 'Tack Shooter', currMonkey = False, key = 'r', path = [{0: 2, 2: 5}], currUpgrades = [0, 0, 0])
VILLAGE: TOWER = TOWER(x = 382, y = 513, name = 'Monkey Village', currMonkey = False, key = 'k', path = [{0: 3, 1: 2}], currUpgrades = [0, 0, 0])
ALCHEMIST: TOWER = TOWER(x = 463, y = 551, name = 'Alchemist', currMonkey = False, key = 'f', path = [{0: 4, 2: 2}, {0: 1}], currUpgrades = [0, 0, 0])
